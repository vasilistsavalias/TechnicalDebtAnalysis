...
public class BattleInventoryUI extends Window  {

    public final static int NUM_SLOTS = 50;
    public static final String PLAYER_INVENTORY = "Player_Inventory";

    private int lengthSlotRow = 10;
    private static Table inventorySlotTable;
...
//        observers = new Array<>();
    ...
    public static Table getInventorySlotTable() {
...
//    public void addObserver(BattleHUD inventoryObserver) {
...
//    }
    ...
    public static void fillInventory(Array<InventoryItemLocation> inventory) {
        BattleInventoryUI.populateInventory(getInventorySlotTable(), inventory, getDragAndDrop(), BattleInventoryUI.PLAYER_INVENTORY, false);
    }
    }
