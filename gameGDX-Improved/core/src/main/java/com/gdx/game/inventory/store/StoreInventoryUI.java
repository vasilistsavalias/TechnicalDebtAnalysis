...
public class StoreInventoryUI extends Window implements InventorySlotObserver, StoreInventorySubject {
    ...
    public void onNotify(InventorySlot slot, SlotEvent event) {
        event.PerformStoreInventoryUIAction(slot, this);
        checkButtonStates();
    }
    ...
    public Label getSellTotalLabel() {
        return sellTotalLabel;
    }

    public Label getBuyTotalLabel() {
        return buyTotalLabel;
    }
}
